...
(module+ test
  ...
  (test-equal? "prefixexp"
               (s-lua->lua #'(#%chunk
                              (#%block
                               (#%local [p1] [literals-and-forms])
                               (#%local [p2] [(#%call f)])
                               (#%local [p3] ['literals-and-forms]))))
  ...
  (test-equal? "namelist function"
               (s-lua->lua
                #'(#%chunk
                   (#%block
                    (#%local (#%function (named-varargs a b #%vararg)
                                         (#%block
                                          (#%return)))))))
  ...
  (test-equal? "vararg-host"
               (s-lua->lua
                #'(#%chunk
                   (#%block
                    (#%local (#%function (vararg-host #%vararg)
                                         (#%block
                                          (#%local [_] [#%vararg])))))))
